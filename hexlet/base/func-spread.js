// которая конвертирует даты в массив
// человеко-читаемых строк на английском языке.
...
const convert = (...params) => {
  ...
  for (const element of params) {
    const date = new Date(...element).toDateString();
    dates.push(date);
  }
...
console.log(convert([1993, 3, 24], [1997, 8, 12], [2001, 10, 18])); // ['Sat Apr 24 1993', 'Fri Sep 12 1997', 'Sun Nov 18 2001']
