 ...
 if (4 == 9) {
   задаем условие
   console.log('Верно!');
   действие, которое выполняется, если условие выполнено
 } else {
   что делать, если не выполяется условие
   console.log('Не верно!');
   действие, которое выполняется, если условие НЕ выполнено
 }
 ...
 switch (num) {
   case 49:
     Первый кейс - если равно 49
     console.log('Неверно');
     break;
     еслм условие выполнилось то скрипт заканчивается - если нет идет дальше
   case 100:
     второй кейс
     console.log('Неверно');
     break;
   ...
   default:
     ...
     действие если не один кейс не подошел
     break;
 }
 ...
 while (num < 55) {
   1 ый тип цикла.пока это условие выполняется мы будем делать это действие
   console.log(num);
   num++;
 }

 do {
   2 ой тип цикла - делай до наступления условия
   console.log(num);
   num++;
 }
 while (num < 55);
 ...
 let num = 50;
 for (let i = 1; i < 10; i++) {
   3 ий тип цикла(старц цикла, конец цикла, шаг)
   if (i == 6) {
     можно добавлять особые условия
     break;
     можно прерывать
     continue;
     или продолжать далее, значение(в данном примере 6) пропустится
   }
   console.log(i);
 }
